/**
*@timerID таймер для последующих сдвигов противника к игроку
*@patno изменение метки
*@blankno смещение противника
*@totalblank общее смещение противников
*@lr сторона, в которую будет произведено смещение, если -1 смещение в лево, если 1 смещение в право
*@lowerlf нижнее боковое пространство
*@downlf верхнее боковое пространство
*@downno смещение противника вниз
*@inplay флаг что игра не закончена
*@missilex позиция ракеты х
*@missiley позиция ракеты y
*@mychrx позиция игрока
*@myblank смещение игрока
*@mymove ограничение игрового поля
*@spcf1 линия ракеты на поле
*@spcf2 линия ракеты на поле
*@spcf3 линия ракеты на поле
*@hitflag местонахождение противников на поле
*@score счёт игрока
*@selec количество противников в одной линии
*@rsmiss промах ракеты
*/
var timerID = null;                 
var patno = 1;
var cr = "\r\n";
